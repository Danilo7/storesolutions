<%-- 
    Document   : industria
    Created on : 11/03/2016, 16:08:35
    Author     : Danilo
--%>
	...
	<div class="page">
		...
		<div class="wrapper">
			<div class="secundary-wrapper">
				<div class="content">
					<div class="title"><h2>Indústria</h2></div>
					<div class="description">
						<p>Indústria - Acelere o crescimento da sua manufatura com software de gestão ERP ideal para sua Industria.</p>
					</div>
					<div class="main-banner">
						<img src="<%= link %>images/banner-industria.jpg" title="Indústria" />
					</div>
				</div>
			</div>
		</div>
