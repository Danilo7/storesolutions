<%-- 
    Document   : contatos
    Created on : 11/03/2016, 16:05:05
    Author     : Danilo
--%>
		...
		<div class="wrapper">
			<div class="secundary-wrapper">
				<div class="content">
					<div class="form">
						<h2>Fale Conosco</h2>
						<form id="submit_form" action="data_contacts.jsp" method="post">
							<label>Assunto: </label><input type="text" name="subject" value="Digite um assunto" />
							<label>Nome: </label><input type="text" name="name"/ value="Seu nome"><span class="required">*</span>
							<label>Email: </label><input type="text" name="email"value="Seu email"/><span class="required">*</span>
							<label>Telefone: </label><input type="text" name="phone" value="Seu telefone"/><span class="required">*</span>
							<label>Mensagem: </label>
							<textarea name="message" value="Escreva á mensagem"></textarea>
							<span class="required">*Campos Obrigatórios</span>
							<div class="button"><span>Enviar</span></div>
						</form>
					</div>
				</div>
			</div>
