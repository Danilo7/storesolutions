<%-- 
    Document   : servicos_sub
    Created on : 11/03/2016, 16:11:06
    Author     : Danilo
--%>
			...
			<div class="secundary-wrapper">
				<div class="content">
					...
					<div class="description">
						<p>Serviços - Ganhe eficiência e reduza custos com software de gestão ERP ideal para prestadores de serviços.</p>
					</div>
					<div class="main-banner">
						<img src="<%= link %>images/banner-servicos.jpg" title="Serviços" />
					</div>
				</div>
			</div>
		</div>
