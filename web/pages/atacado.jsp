<%-- 
    Document   : atacado
    Created on : 11/03/2016, 16:02:06
    Author     : Danilo
--%>
	...
	<div class="page">
		...
		<div class="wrapper">
			<div class="secundary-wrapper">
				<div class="content">
					<div class="title"><h2>Atacado</h2></div>
					<div class="description">
						<p>Atacado - Otimize seu inventário e alavanque seus resultados com software de gestão ERP ideal para distribuidores e atacadistas.</p>
					</div>
					<div class="main-banner">
						<img src="<%= link %>images/banner_atacado.jpg" title="Atacado" />
					</div>
				</div>
			</div>
		</div>
